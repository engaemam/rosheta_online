                ...
                @include('layouts.message')
                   <div class="left_side_details">
                      <div class="details_title">
							...
							<ul class="list-inline">
								<li>
									...
									<p><img src="/patient/img/icons/phone-call-G2.png" class="img-responsive" alt=""/> {{$hospital->phone}}, {{$hospital->mobile}}. </p>
								</li>	
								<li>
									<img src="/patient/img/icons/icon_user.png" class="img-responsive" alt=""/> {{App\Doctor::find($hospital->doctor_id)->name}} </p>
								</li>
								<li>
									<p>*Examin cost: <span class="btn btn-info">{{$hospital->ex_price}} $ </span> </p>
                      ...
                      <div class="project_d_slider">
                           <div class="demo">
                            <div class="item">
                              <img src="/assets/img/{{$hospital->img}}" width="100%" class="img-responsive carousel_imgs" alt=""/>
                            </div>
                        </div>	  
                      </div>
                   ...
                   <div class="right_side_details">
                       <div class="pos_fixed">
                           ...
                           <div class="send_email">
                            <form id="msg_form" method="post" action="{{url('/reply/doctor')}}">
                              {{csrf_field()}}
                            <input type="hidden" value="{{$hospital->doctor_id}}" name="doctor_id">
