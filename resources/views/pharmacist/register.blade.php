                     ...
                     <div class="col-lg-8 col-md-8">
                        <div class="card">
                           <div class="card-body">
                              ...
                              <h3 class="text-muted text-center font-18"><b>Register Personal information & Your Pharmacy Information</b></h3>
                              @include('layouts.message')
                              <div class="p-3">
                                 <form class="form-horizontal" id="ph_reg" method="post" enctype="multipart/form-data" action="{{url('/pharmacist/doregister')}}">
                                    {{csrf_field()}}
                                    <div class="form-group row">
                                       <div class="col-6"><input class="form-control" value="{{old('name')}}"  type="text" name="name" required="" placeholder="Your name"></div>
                                       <div class="col-6"><input class="form-control" value="{{old('pharmacy_name')}}"  type="text" name="pharmacy_name" required="" placeholder="pharmacy name"></div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-6"><input class="form-control" value="{{old('email')}}"  name="email" type="email" required="" placeholder="Your email"></div>
                                       <div class="col-6"><input class="form-control"value="{{old('pharmacy_country')}}"  name="pharmacy_country" type="text" required="" placeholder="pharmacy country name"></div>
                                    </div>
                                    <div class="form-group row">
                                       <div class="col-6"><input class="form-control"  name="password" type="password" required="" placeholder="Your password"></div>
                                       <div class="col-6"><input class="form-control" value="{{old('pharmacy_address')}}"  name="pharmacy_address" type="text" required="" placeholder="pharmacy address"></div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-6"><input class="form-control" value="{{old('pharmacy_phone')}}"  name="pharmacy_phone" type="text" required="" placeholder="pharmacy phone"></div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-6"><input class="form-control" value="{{old('mobile')}}" name="mobile" type="text" required="" placeholder="Your mobile"></div>
                                       <div class="col-6"><input class="form-control" value="{{old('pharmacy_mobile')}}" name="pharmacy_mobile" type="text" required="" placeholder="pharmacy mobile"></div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-6"><span class="btn btn-primary btn-file" style="margin-bottom: 5px;">
                                          <i class="fa fa-image"></i> pharmacy photo <input class="form-control" name="pharmacy_img" style=" opacity:0; height: 10px; width: 50px;" type="file" required="" ></span></div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-12"> <textarea class="form-control" rows="5" name="summary" type="text" required="" placeholder="Pharmcy details">{{old('summary')}}</textarea> </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group m-t-10 mb-0 row">
                                       <div class="col-12 m-t-20 text-center"><a href="{{url('pharmacist/login')}}" class="text-muted">Already have account?</a></div>
                                    </div>
                                 </form>
                              </div>
