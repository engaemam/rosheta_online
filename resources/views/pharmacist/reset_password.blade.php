                     ...
                     <div class="col-lg-5 col-md-8">
                        <div class="card">
                           <div class="card-body">
                              ...
                              <h4 class="text-muted text-center font-18"><b>Pharmacist Reset Password</b></h4>
                              @include('layouts.message')
                              <div class="p-2">
                                 <form class="form-horizontal m-t-20" method="post" id="doc_log">
                                    {{csrf_field()}}
                                    <div class="form-group row">

                                       <div class="col-12"><input class="form-control" name="email" value="{{$data->email}}" type="text" required="" placeholder="Email"></div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                       <div class="col-12"><input class="form-control" type="password"  name="password_confirmation" required="" placeholder="Password"></div>
                                    </div>
                                    
                                    <div class="form-group text-center row m-t-20">
                                       <div class="col-12"><button  onclick="document.getElementById('doc_log').submit();" class="btn btn-primary btn-block waves-effect waves-light" type="submit">Reset Password</button></div>
                                    </div>
