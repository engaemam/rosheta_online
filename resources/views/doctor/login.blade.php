                     ...
                     <div class="col-lg-5 col-md-8">
                        <div class="card">
                           <div class="card-body">
                              ...
                              <h4 class="text-muted text-center font-18"><b>Doctor Sign In</b></h4>
                              @include('layouts.message')
                              <div class="p-2">
                                 <form class="form-horizontal m-t-20" method="post" id="doc_log" action="{{url('check/doctor')}}">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group text-center row m-t-20">
                                       <div class="col-12"><button  onclick="document.getElementById('doc_log').submit();" class="btn btn-primary btn-block waves-effect waves-light" type="submit">Log In</button></div>
                                    </div>
                                    <div class="form-group m-t-10 mb-0 row">
                                       <div class="col-sm-7 m-t-20"><a href="{{url('/dforget/password')}}" class="text-muted"><i class="mdi mdi-lock"></i> Forgot your password?</a></div>
                                       <div class="col-sm-5 m-t-20"><a href="{{url('/doctor/register')}}" class="text-muted"><i class="mdi mdi-account-circle"></i> Create an account</a></div>
                                    </div>
                                 </form>
                              </div>
                           </div>
