                     ...
                     <div class="col-lg-5 col-md-8">
                        <div class="card">
                           <div class="card-body">
                              ...
                              <h4 class="text-muted text-center font-18"><b>Doctor Forgot Password</b></h4>
                              @include('layouts.message')
                              <div class="p-2">
                                 <form class="form-horizontal m-t-20" method="post" id="doc_log" action="{{url('/doctor/forget')}}">
                                    {{csrf_field()}}
